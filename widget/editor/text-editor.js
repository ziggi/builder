$(function() {
	...
	$(document).on('textEditor', '.widget-text-editing', function(event, type, focus) {
		var toolbar_items = "forecolor fontselect fontsizeselect bold italic underline bullist numlist | alignleft aligncenter alignright | link | done";

		if (type == 'headline') {
			toolbar_items = "forecolor fontselect fontsizeselect bold italic underline | alignleft aligncenter alignright | link | done";
		}
